...
cli({
  ...
  columns: ['title', 'frameCount', 'frames', 'source', 'designPlatform', 'variables'],
  func: async (page, args) => {
    ...
    return [{ title: meta.title, frameCount: meta.frameCount, frames: meta.frames, source: meta.source, designPlatform: meta.designPlatform, variables: meta.variables }];
  },
});
